...
const AssignmentCreatePage = () => {
  ...
  const {createAssignment, uploadFiles} = AssignmentAPI();
  ...
  const modules = {
    toolbar: {
      container: [[{'size': ['small', false, 'large', 'huge']}], [{'font': []}], ['bold', 'italic', 'underline', 'strike'], [{'color': []}, {'background': []}], [{'list': 'ordered'}, {'list': 'bullet'}], [{'align': []}], ['link', 'image'], ['clean']],
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (files.length > 0 && assignmentResponse.id) {
        await uploadFiles(files, assignmentResponse.id);
      }
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        <div className="max-w-4xl mx-auto">
          ...
          {error && (<div className="bg-red-50 text-red-600 p-4 rounded-lg mb-6">
            {error}
          </div>)}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  style={{
                    '-webkit-datetime-edit-text': {'-webkit-appearance': 'none'},
