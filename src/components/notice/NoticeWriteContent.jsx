...
const NoticeWriteContent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('type', 'COURSE'); // NoticeType.COURSE 설정
      formData.append('courseId', courseId);

      // 현재 로그인한 강사의 ID를 추가 (이 부분은 인증 컨텍스트에서 가져와야 함)
      const instructorId = localStorage.getItem('userId'); // 예시입니다. 실제 구현에 맞게 수정 필요
      ...
      navigate(`/courses/${courseId}/notices`); // 강의 공지사항 목록으로 이동
    } catch (err) {
