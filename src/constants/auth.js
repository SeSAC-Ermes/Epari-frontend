...
export const FEATURE_PERMISSIONS = Object.freeze({
  ...
  // 공지사항 관련 기능
  CREATE_NOTICE_COURSE: [ROLES.INSTRUCTOR],
  EDIT_NOTICE: [ROLES.INSTRUCTOR],
  DELETE_NOTICE: [ROLES.INSTRUCTOR],
  VIEW_NOTICE: [ROLES.INSTRUCTOR, ROLES.STUDENT],
  MANAGE_NOTICE: [ROLES.INSTRUCTOR]
});
