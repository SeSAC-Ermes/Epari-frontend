...
export const PAGE_PERMISSIONS = Object.freeze({
  ...
  COURSE_MATERIAL_UPLOAD: [ROLES.INSTRUCTOR],
  STUDENT_MANAGEMENT: [ROLES.INSTRUCTOR],
  ...
  // 시험 관련
  EXAM_LIST: [ROLES.INSTRUCTOR, ROLES.STUDENT],
  EXAM_CREATION: [ROLES.INSTRUCTOR],
  EXAM_EDIT: [ROLES.INSTRUCTOR],
  EXAM_VIEW_ANSWERS: [ROLES.INSTRUCTOR],
  EXAM_TAKE: [ROLES.STUDENT],
  EXAM_GRADING: [ROLES.INSTRUCTOR],  // 추가
  EXAM_VIEW_RESULT: [ROLES.INSTRUCTOR, ROLES.STUDENT]  // 추가
});
...
export const FEATURE_PERMISSIONS = Object.freeze({
  ...
  // 시험 관련 기능
  GRADE_EXAM: [ROLES.INSTRUCTOR],  // 추가
  VIEW_EXAM_STATS: [ROLES.INSTRUCTOR],  // 추가
  VIEW_OWN_RESULT: [ROLES.STUDENT],  // 추가
  EXAM_GRADING: [ROLES.INSTRUCTOR],  // 채점 권한
  EXAM_VIEW_RESULT: [ROLES.INSTRUCTOR, ROLES.STUDENT]
});
